export default function Ases() {
  const bannerText =
    "¡Aprovechá el bono de bienvenida y ganá más! ¡No te lo pierdas! ";

  return (
    <div
      className="relative flex flex-col items-center justify-center min-h-screen text-black ases-body pb-10 bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: "url('/luck-839036_1280.jpg')" }}
    >
      ...
      <div className="fixed top-0 left-0 w-full overflow-hidden z-50 banner-container">
        ...
        <img src="/asesnortes.png" alt="DianaWIN" className="h-25 mt-8" />
